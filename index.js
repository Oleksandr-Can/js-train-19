...
// Зробимо щоб 'info' не можно було видалити або змінити, перевіримо і спробуємо присвоїти ій будь яке значення 
//(це потрібно робити ззовні defineProperty),
//     writable: false,
//     writable: false,
// })
